...
int get_vertex_id(Graph graph,char *name); // return value(number) of vertex with key : id
char* get_vertex_name(Graph graph,int id); // return value(name) of vertex with key : id
void add_edge(Graph graph,int v1,int v2,char *name); // from v1 to v2
